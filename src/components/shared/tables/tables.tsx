...
import { useTable, useSortBy, Row, IdType } from 'react-table';
    ...
    () => [
      ...
      },
      {
        ...
        Cell: ({ value }: { value: Period }) =>
          value.totalCases.toLocaleString(undefined, {
  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        ...
        accessor: 'periods[5]',
        Cell: ({ value }: { value: Period }) =>
          value.newCases.toLocaleString(undefined, {
            minimumFractionDigits: 0,
            maximumFractionDigits: 0,
          }),
        getClassName: (period: Period) => formatCell(period).className,
  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        ...
        accessor: 'periods[5]',
        Cell: ({ value }: { value: Period }) =>
          value.totalDeaths.toLocaleString(undefined, {
            minimumFractionDigits: 0,
            maximumFractionDigits: 0,
          }),
        getClassName: (period: Period) => formatCell(period).className,
  ...
  const columns = React.useMemo(
    () => [
      ...
      },
      {
        ...
        accessor: 'periods[5]',
        Cell: ({ value }: { value: Period }) =>
          value?.newDeaths.toLocaleString(undefined, {
            minimumFractionDigits: 0,
            maximumFractionDigits: 0,
          }) ?? '',
        getClassName: (period: Period) => formatCell(period).className,
